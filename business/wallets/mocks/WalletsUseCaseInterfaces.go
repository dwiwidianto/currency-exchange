...
// WalletsUseCaseInterfaces is an autogenerated mock type for the WalletsUseCaseInterfaces type
type WalletsUseCaseInterfaces struct {
	mock.Mock
}

// CreateWallets provides a mock function with given fields: ctx, createTableWallet
func (_m *WalletsUseCaseInterfaces) CreateWallets(ctx context.Context, createTableWallet *wallets.Domain) (wallets.Domain, error) {
...
func (_m *WalletsUseCaseInterfaces) DeleteWallets(ctx context.Context, id int) error {
...
func (_m *WalletsUseCaseInterfaces) GetAllWallets(ctx context.Context) ([]wallets.Domain, error) {
	ret := _m.Called(ctx)
